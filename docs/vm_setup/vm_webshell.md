 ...
 * click on `Open Web Shell` to open a new browser tab/window.<br><img src="https://iujetstream.atlassian.net/wiki/download/thumbnails/778698753/Webshell_1.png?version=1&modificationDate=1573672029727&cacheVersion=1&api=v2&width=1400&height=590">
 ...
 * Alternatively, selecting text in the `WebShell` automatically places it in the Clipboard where it may be cut or pasted normally.<br>
 ...
 <img src="https://iujetstream.atlassian.net/wiki/download/thumbnails/778698753/Webshell_copy_paste.png?version=1&modificationDate=1573672029579&cacheVersion=1&api=v2&width=811&height=998">
